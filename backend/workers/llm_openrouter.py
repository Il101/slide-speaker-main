...
4. Uses appropriate transitions and connecting phrases
5. Is approximately 100-200 words (30-60 seconds of speech)
...
"""
    ...
    def _generate_lecture_text_mock(self, elements: List[Dict]) -> str:
        ...
        if not text_parts:
            return "Let's discuss the content of this slide together. This slide contains important information that we need to review."
        
        # Create natural lecture text
        slide_content = ' '.join(text_parts)
        
        # Generate mock lecture text that sounds natural
        lecture_text = f"Let's look at this slide together. {slide_content}. This is an important point that I want to highlight for you. As you can see, this information helps us understand the topic better."
