#!/usr/bin/env python3
"""
Создание Document AI Processor (исправленная версия)
"""
import os
import sys
...
def create_document_ai_processor():
    """Создание Document AI Processor"""
    
    print("🔧 Создание Document AI Processor")
    print("=" * 50)
    
    project_id = os.getenv("GCP_PROJECT_ID")
    location = "us"  # Регион где развернут Document AI
    ...
    try:
        ...
        print(f"📋 Название: {result.display_name}")
        print(f"📋 Тип: {result.type_}")
...
if __name__ == "__main__":
    ...
    if processor_id:
        ...
        print(f"1. Создайте Processor вручную в Google Cloud Console")
        print(f"2. Перейдите в Document AI → Create Processor")
        print(f"3. Выберите тип 'Document OCR' и регион 'us'")
        print(f"4. Скопируйте новый Processor ID")
