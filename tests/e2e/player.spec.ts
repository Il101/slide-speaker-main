...
test.describe('Player Functionality', () => {
  test('should play lecture with classic pipeline', async ({ page }) => {
    // Navigate to the player page with pipeline parameter
    await page.goto('/?lesson=demo&pipeline=classic');
  ...
  test('should display lecture text with classic pipeline', async ({ page }) => {
    // Navigate to the player page with pipeline parameter
    await page.goto('/?lesson=demo&pipeline=classic');
